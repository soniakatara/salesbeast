...
export const Input = React.forwardRef<HTMLInputElement, InputProps>(
  function Input({ label, error, hint, className = "", id, ...rest }, ref) {
    ...
    const base =
      "w-full bg-neutral-900 border border-neutral-800 rounded-sm px-3 py-2 text-sm text-neutral-100 placeholder-neutral-500 focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500 outline-none transition-colors";
